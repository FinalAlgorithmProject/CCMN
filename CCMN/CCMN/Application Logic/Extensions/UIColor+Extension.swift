...
extension UIColor {
    ...
    /// Color of login and forgot password buttons
    static var warningRedColor: UIColor {
        return UIColor(red:0.91, green:0.35, blue:0.39, alpha:1.0)
    }
    
//    static var textFieldUnactive: UIColor {
//        return UIColor(red:0.51, green:0.51, blue:0.51, alpha:1.0)
//    }
//
//    static var textFieldActive: UIColor {
//        return UIColor(red:0.24, green:0.24, blue:0.25, alpha:1.0)
//    }
...
//    static var fsCalendarTitleBackground: UIColor {
...
//    static var unreadDocumentBackgroundColor: UIColor {
//        return UIColor(red:0.89, green:0.92, blue:1.00, alpha:0.87)
//    }
}
